    ...
    <>
      ...
      >
        ...
        <div className="workspace-subtle" style={{ marginTop: '6px', fontSize: '13px', lineHeight: 1.55 }}>
          Use your reading profile to rank ICLR results against the live conference graph.
        </div>
        ...
        <div className="workspace-mobile-stack" style={{ marginTop: '14px' }}>
          <span className="workspace-pill" data-tone="accent">ICLR 2025</span>
        ...
        >
          {isSearching ? 'Analyzing...' : 'Rank ICLR Papers'}
        </button>
